describe('Create User Negative - Validation Username', () => {
    ...
    it('kolom Username wajib diisi', () => {
        ...
        // Kosongkan Username
        cy.get('[id*="app-text-field-Username"]').clear();
        ...
        cy.get('body').should(($body) => {
            const t = $body.text();
            expect(/username.*wajib|wajib.*username|username.*diisi/i.test(t)).to.be.true;
        });

        cy.screenshotFull('create-user-validation-username-wajib-diisi');
    });
